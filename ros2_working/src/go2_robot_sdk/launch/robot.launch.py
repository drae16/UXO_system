...
class Go2LaunchConfig:
    ...
    def _get_config_paths(self) -> dict:
        ...
        return {
            ...
            'nav2': os.path.join(self.package_dir, 'config', 'nav_params.yaml'),
            'rviz': os.path.join(self.package_dir, 'config', self.rviz_config),
            'urdf': os.path.join(self.package_dir, 'urdf', self.urdf_file),
            'navsat_config' : os.path.join(self.package_dir, 'config', 'navsat_params.yaml'),
...
class Go2NodeFactory:
    ...
    def create_teleop_nodes(self) -> List[Node]:
        ...
        return [
            ...
            Node(
                package='go2_robot_sdk',
                executable='odom_covariance_node',
            ...
            Node(
                ...
                output='screen',
                parameters=[self.config.config_paths['navsat_config']],
            ...
            Node(
                package='go2_robot_sdk',
                executable='fix_origin_publisher',
                name='fix_origin_publisher',
                output='screen'
            ),

            Node(
                package='go2_robot_sdk',
                executable='GPS_secondary',
                name='GPS_secondary',
                output='screen'
            ),
